...
<head>
    ...
    <title><?php echo e(config('app.name', 'Cegah Banjir')); ?> - Welcome</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
    <link href="<?php echo e(asset('css/cegahbanjir.css')); ?>" rel="stylesheet">
        ...
        <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-white slide-in">
                ...
                <div class="flex flex-col sm:flex-row gap-4 animate-fade-in" style="animation-delay: 0.8s;">
                    <a href="<?php echo e(url('/status-banjir')); ?>" class="accent-bg-blue text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl inline-block text-decoration-none">
        ...
        <div class="max-w-6xl mx-auto text-center accent-black">
            ...
            <div class="border-t border-gray-200 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <p>&copy; <?php echo e(date('Y')); ?> Cegah Banjir. All rights reserved.</p>
...
<?php /**PATH C:\Users\Devy Relliani\College_Project\PPPL\cegah-banjir\resources\views/welcome.blade.php ENDPATH**/ ?>